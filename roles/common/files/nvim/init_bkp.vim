...
" Simple remap to make it easier to fold code in python at least
...
Plug 'tpope/vim-commentary'     " installed
Plug 'ayu-theme/ayu-vim'        " installed
Plug 'nvim-treesitter/nvim-treesitter', {'do': ':TSUpdate'}    " installed
Plug 'mbbill/undotree'          " installed
Plug 'RRethy/vim-illuminate'    " installed
Plug 'nvim-lua/plenary.nvim'    " installed
Plug 'tpope/vim-fugitive'       " installed
Plug 'kdheepak/lazygit.nvim'    " installed
Plug 'tpope/vim-sensible'       " not necessary
Plug 'junegunn/fzf'
...
Plug 'AndrewRadev/tagalong.vim' " not necessary
...
Plug 'yuezk/vim-js'             " not necessary
...
" TODO: add and research the following plugins: 
